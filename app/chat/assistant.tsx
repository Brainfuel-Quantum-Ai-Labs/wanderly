cat > app/chat/assistant.tsx << 'EOF'
...
export default function AssistantScreen() {
  ...
  const generateAIResponse = (userInput: string): { text: string; suggestions: string[] } => {
    ...
    if (lowerInput.includes('flight') || lowerInput.includes('fly')) {
      return {
        text: "✈️ I'd love to help you book a flight! Where would you like to go, and when are you planning to travel?",
      ...
      return {
        text: "🏨 Great! I can find you the perfect place to stay. What's your destination and dates?",
        suggestions: ['Search hotels', 'View recommendations', 'Filter by price', 'Show map view'],
      };
    } else if (lowerInput.includes('paris')) {
      return {
        text: "🗼 Paris is amazing! The best time to visit is April-June or September-November. I can help you with flights from $450 and hotels from $89/night. What would you like to book first?",
        suggestions: ['Search flights to Paris', 'Find hotels', 'Book tours', 'View itinerary'],
      };
    } else if (lowerInput.includes('tokyo')) {
      return {
        text: "🗾 Tokyo is incredible! Flights from $650, hotels from $75/night. Best areas: Shibuya, Shinjuku, Ginza. Shall I start planning your trip?",
        suggestions: ['Book Tokyo trip', 'View hotels', 'Flight deals', 'Travel guide'],
      };
    } else if (lowerInput.includes('bali')) {
      return {        text: "🏝️ Bali is paradise! Perfect for beaches and temples. Flights from $550, villas from $50/night. Ready to plan your escape?",
        suggestions: ['Plan Bali trip', 'Find villas', 'Flight search', 'Activity booking'],
      };
    } else {
      return {
        text: "I can help you with flights, hotels, car rentals, and complete trip planning. What would you like to explore?",
      ...
      <View style={styles.inputContainer}>
        ...
        <View style={styles.inputWrapper}>
          <TextInput
            ...
            placeholderTextColor="#9CA3AF"            value={inputText}
...
const styles = StyleSheet.create({
  ...
  suggestionChip: {    backgroundColor: '#EEF2FF',
    paddingHorizontal: 16,
    paddingVertical: 10,
    borderRadius: 20,
    borderWidth: 1,
